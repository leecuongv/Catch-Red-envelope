...
from red_envelope import Red_envelope
from cat import Cat
import cv2
import ui
...
class Game:
    ...
    def spawn_insects(self):
        ...
        if t > self.insects_spawn_timer:
            self.insects_spawn_timer = t + RED_ENVELOPES_SPAWN_TIME
            ...
            if random.randint(0, 100) < nb:
                ...
                self.insects.append(Red_envelope())

            # spawn a other red_envelope after the half of the game
